...
On the base layer, tap the outer right thumb for `"` and hold it for Right Alt/Option. The far-right bottom key remains Right Shift, and apostrophe remains on the home row above it.
